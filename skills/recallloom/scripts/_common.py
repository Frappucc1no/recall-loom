...
from core.workspace import atomic_io as workspace_atomic_io
from core.workspace import runtime as workspace_runtime
from core.workspace.atomic_io import (
...
from core.continuity.daily_log import (
    ...
    daily_log_cursor_matches_empty_scaffold,
    ...
    malformed_daily_log_entry_marker_lines,
    parse_daily_log_entry_line,
    sorted_active_daily_log_files,
    sorted_daily_log_files,
    state_claims_entry_bearing_latest_daily_log,
...
def write_text(path: Path, text: str) -> None:
    workspace_atomic_io.atomic_write_text(path, text)
